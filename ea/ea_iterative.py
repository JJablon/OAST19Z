...
#    - Use itertools.product to create all combinations of paths
#    - Map paths ids to link sets
#    - Use reduce to flat list of lists of links to list of used links
#    - Count how many times was each link used (using from collections import Counter)
...
class EvolutionAlgorithm:
    ...
    def combinations(self):
        x = [1, 2, 3, 4, 5, 6]
        print(list(itertools.product(x, repeat=3))
)
    def solve(self):
